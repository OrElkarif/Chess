...
public class OpeningBook {
    ...
    public boolean isOpeningDone() { return openingDone; }
    public void setOpeningDone(boolean done) { this.openingDone = done; }

    public Move getNextMove(GameState state, Evaluator evaluator) {
        if (openingDone) return null;

        // יציאה אם המלכה הלבנה התחילה להתקיף
        ...
        // אם המשבצת מאוימת נבטל את הפתיחה הקבועה!
