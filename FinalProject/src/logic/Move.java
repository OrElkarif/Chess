...
public class Move {
	...
	public void DoThisMove(GameState state) {
	    ...
	    if (_isPromotion && _promoteTo != null) {
	        // 1. מחליפים את הרגלי במלכה בלוח הדו-ממדי
	        state.get_board()[_toRow][_toCol] = _promoteTo;
	        
	        // 2. מעדכנים את המיקום הפנימי של המלכה החדשה
	        _promoteTo.setRow(_toRow);
	        _promoteTo.setCol(_toCol);
	        
	        // 3. עדכון רשימות (קריטי לתיקו ולחישובים):
	        // מסירים את הרגלי שהגיע לסוף ומוסיפים מלכה
