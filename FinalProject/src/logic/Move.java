...
public class Move implements java.io.Serializable {//שומרת בתוכה את כל הנתונים על צעד שמישהו שיחק
	...
	public Piece _piece;
	private byte _fromCol, _fromRow;
	private byte _toCol, _toRow;
	...
	private byte _enPassantCaptureRow;
	private byte _enPassantCaptureCol;

	public Move(Piece p, int fromC, int fromR, int toC, int toR) {//מקבל int לנוחות הקריאה ומבצע cast פנימי לbyte
		_piece = p;
		_fromCol = (byte) fromC;
		_fromRow = (byte) fromR;
		_toCol   = (byte) toC;
	...
	public byte get_fromCol() { return _fromCol; }
	public byte get_fromRow() { return _fromRow; }
	public byte get_toCol()   { return _toCol; }
	public byte get_toRow()   { return _toRow; }
	...
	public void setEnPassantCapture(int row, int col, Piece piece) {//מקבל int ומבצע cast לbyte
	    this._enPassantCaptureRow = (byte) row;
	    this._enPassantCaptureCol = (byte) col;
